        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-col items-center">
              <label className="block mb-4 text-[#374151] font-medium text-sm sm:text-base">Enter 6-digit code</label>
              <InputOTP
                maxLength={6}
                value={otp}
          ...
          <div className="text-center mt-6">
            <Link to="/forgot-password" university-link="true" className="inline-flex items-center text-sm text-[#3b82f6] hover:underline font-medium">

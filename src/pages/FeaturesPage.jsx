  ...
  const mainFeatures = [
    {
      ...
      description: 'Advanced search filters to discover influencers that align with your brand values and target audience. Filter by niche, location, audience size, engagement rate, and more.',
      color: 'bg-[#3b82f6]',
    ...
    },
    {
      ...
      description: 'Streamlined tools to create, manage, and track your influencer campaigns all in one place. From planning to execution, handle everything seamlessly.',
      color: 'bg-[#10b981]',
    ...
    },
    {
      ...
      description: 'Monitor campaign performance with comprehensive analytics and detailed reporting dashboards. Track ROI, engagement, reach, and conversion metrics.',
      color: 'bg-[#f59e0b]',
    ...
    },
    {
      ...
      description: 'Work with confidence knowing all influencers are verified and authenticated by our team. Badges indicate verification status and credibility.',
      color: 'bg-[#8b5cf6]',
  ...
  const additionalFeatures = [
    {
      ...
      description: 'Send, receive, and manage collaboration requests with detailed proposal templates and automated workflows.',
    },
    {
      icon: Briefcase,
      title: 'Portfolio Management',
      description: 'Showcase your work with customizable portfolios. Display past campaigns, media kits, and success stories.',
    },
    {
      icon: Bell,
      title: 'Smart Notifications',
      description: 'Stay updated with real-time notifications for new requests, campaign updates, and important milestones.',
    },
    {
      icon: Calendar,
      title: 'Campaign Scheduling',
      description: 'Plan and schedule your campaigns in advance with integrated calendar tools and timeline management.',
    },
    {
      icon: FileText,
      title: 'Contract Templates',
      description: 'Access professional contract templates and automated agreements to streamline your collaboration process.',
    },
    {
      icon: BarChart3,
      title: 'Performance Reports',
      description: 'Generate detailed performance reports with exportable data and visual insights for stakeholders.',
    },
    {
      icon: Users,
      title: 'Team Collaboration',
      description: 'Invite team members, assign roles, and collaborate efficiently with built-in permission management.',
    },
    {
      icon: Lock,
      title: 'Secure Payments',
      description: 'Handle payments securely with escrow protection, milestone-based releases, and transaction tracking.',
    },
    {
      icon: Globe,
      title: 'Multi-Platform Support',
      description: 'Connect multiple social media accounts and manage cross-platform campaigns from one dashboard.',
    },
    {
      icon: Eye,
      title: 'Audience Demographics',
      description: 'Access detailed audience insights including age, gender, location, interests, and behavior patterns.',
    },
    {
      icon: Settings,
      title: 'Custom Workflows',
      description: 'Create custom approval workflows, automated responses, and personalized campaign management processes.',
    },
    {
      icon: Sparkles,
      title: 'AI-Powered Matching',
      description: 'Leverage AI algorithms to get personalized influencer recommendations based on your brand profile.',
    },
  ];
  ...
  const benefits = [
    {
      icon: Zap,
      title: 'Save Time',
      description: 'Reduce campaign setup time by 80% with automated workflows and smart tools.',
    },
    {
      icon: TrendingUp,
      title: 'Boost ROI',
      description: 'Increase campaign ROI by 3x with data-driven insights and perfect matches.',
    },
    {
      icon: CheckCircle,
      title: 'Verified Quality',
      description: 'Work with verified influencers and brands for authentic, safe collaborations.',
    },
    {
      icon: Rocket,
      title: 'Scale Faster',
      description: 'Manage multiple campaigns simultaneously and grow your influence network.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#6b7280] max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
              Everything you need to discover, connect, and collaborate with the perfect partners. 
              From advanced search to real-time analytics, we've got you covered.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
              <InfluButton variant="primary" size="lg" onClick={() => navigate('/register')} className="w-full sm:w-auto">
                Get Started Free
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
              </InfluButton>
              <InfluButton variant="outline" size="lg" onClick={() => navigate('/contact')} className="w-full sm:w-auto">
                Contact Sales
              </InfluButton>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 max-w-5xl mx-auto px-4">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center shadow-lg border border-[#e5e7eb]">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#3b82f6] mb-1 sm:mb-2">{stat.value}</div>
            ...
            {mainFeatures.map((feature, index) => (
              ...
              >
                ...
                <div className="relative">
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 ${feature.color} rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}>
                  ...
                  <p className="text-sm sm:text-base text-[#6b7280] mb-4 leading-relaxed">{feature.description}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {additionalFeatures.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-base sm:text-lg font-semibold text-[#111827] mb-2">{feature.title}</h3>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#6b7280] max-w-2xl mx-auto">
              Join thousands of brands and influencers who trust Brandly for their collaborations
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-[#111827] mb-2">{benefit.title}</h3>
                <p className="text-sm sm:text-base text-[#6b7280]">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-[#e5e7eb] hover:border-[#3b82f6] transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#111827] mb-3 sm:mb-4">For Brands</h3>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-[#e5e7eb] hover:border-[#8b5cf6] transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#111827] mb-3 sm:mb-4">For Influencers</h3>
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-[#6b7280]">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#10b981] flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-[#e5e7eb] hover:border-[#10b981] transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#111827] mb-3 sm:mb-4">For Teams</h3>
              <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-[#6b7280]">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#10b981] flex-shrink-0 mt-0.5" />
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-[#3b82f6] to-[#8b5cf6]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8">
            Join thousands of successful brands and influencers on Brandly today. 

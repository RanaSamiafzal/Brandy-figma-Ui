...
import { Shield, Search, Filter, Users, Star, MapPin, TrendingUp, ArrowRight, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Search by niche, audience size, engagement rate, location, and more to find your perfect match.',
    },
    {
      icon: Users,
      title: 'Audience Insights',
      description: 'View detailed demographics and interests of each influencer\'s audience before reaching out.',
    },
    {
      icon: Star,
      title: 'Performance Metrics',
      description: 'Compare influencers based on past campaign performance and engagement statistics.',
    },
    {
      icon: MapPin,
      title: 'Location Targeting',
      description: 'Find influencers in specific cities, regions, or countries to reach your target market.',
    },
  ];
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-lg max-w-sm border border-[#e5e7eb]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="font-semibold text-[#111827]">156 Matches Found</div>
                  <div className="text-sm text-[#6b7280]">Based on your criteria</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#6b7280] max-w-2xl mx-auto">
              Our intelligent matching system helps you find influencers who are the perfect fit for your campaigns.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {steps.map((step, index) => (
              <div key={index} className="flex items-start gap-6 bg-white p-6 rounded-xl border border-[#e5e7eb]">
